...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if (ISEMPTY(_models)) {
        ...
        UIImageView *imgV = [[UIImageView alloc] initWithFrame:CGRectMake(50, 11, 32, 32)];
        ...
        UILabel *l2 = [[UILabel alloc] initWithFrame:CGRectMake(0, 65, _w, 50)];
        l2.text = @"还需一步即可享用已下载的快券";
        l2.textAlignment = NSTextAlignmentCenter;
        l2.textColor = kColorRed;
        l2.font = nFont(15);
...
- (IBAction)showDownloadGuide{
    // 调用CouponDetails的显示Guide，然后退回CouponDetails
    
    [_vc showDownloadGuide];
...
- (void)toCouponList{
    ...
    [nav.view performSelector:@selector(removeFromSuperview) withObject:nil afterDelay:.5];
